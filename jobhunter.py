...
def create_tables(cursor):
    ...
    cursor.execute('''CREATE TABLE IF NOT EXISTS jobs (id INT PRIMARY KEY auto_increment, Job_id varchar(150) , 
    company varchar (300), Created_at DATE, url LONGBLOB, Title LONGBLOB, Description LONGBLOB ); ''')
